...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/vendor/etc/camera/imx241_chromatix.xml:$(TARGET_COPY_OUT_VENDOR)/etc/camera/imx241_chromatix.xml \
    $(LOCAL_PATH)/rootdir/vendor/etc/camera/imx300_chromatix.xml:$(TARGET_COPY_OUT_VENDOR)/etc/camera/imx300_chromatix.xml

# Fstab
PRODUCT_COPY_FILES += \
    device/sony/loire/rootdir/vendor/etc/fstab.loire:$(TARGET_COPY_OUT_RAMDISK)/fstab.kugo \
    device/sony/loire/rootdir/vendor/etc/fstab.loire:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.kugo

# Init
PRODUCT_COPY_FILES += \
    device/sony/loire/rootdir/vendor/etc/init/hw/init.loire.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.kugo.rc \
    device/sony/loire/rootdir/vendor/etc/init/hw/init.loire.pwr.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.kugo.pwr.rc \
    device/sony/loire/rootdir/vendor/etc/init/hw/init.loire.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.kugo.usb.rc

# Init Recovery
PRODUCT_COPY_FILES += \
    device/sony/loire/rootdir/init.recovery.rc:recovery/root/init.recovery.kugo.rc
